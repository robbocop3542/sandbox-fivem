...
function RetrieveComponents()
	...
	Casino = exports["Paradise-base"]:FetchComponent("Casino")
	Loot = exports["Paradise-base"]:FetchComponent("Loot")
end

AddEventHandler("Core:Shared:Ready", function()
	exports["Paradise-base"]:RequestDependencies("Casino", {
		"Fetch",
		"Utils",
		"Execute",
		"Chat",
		...
		if #error > 0 then
			exports["Paradise-base"]:FetchComponent("Logger"):Critical("Casino", "Failed To Load All Dependencies")
			return
		end
		RetrieveComponents()
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["Paradise-base"]:RegisterComponent("Casino", _CASINO)
end)
