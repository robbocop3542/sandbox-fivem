...
function RetrieveComponents()
    ...
    Dealerships = exports['Paradise-base']:FetchComponent('Dealerships')
    ...
    Default = exports['Paradise-base']:FetchComponent('Default')
    Chat = exports['Paradise-base']:FetchComponent('Chat')
    MDT = exports['Paradise-base']:FetchComponent('MDT')
end

AddEventHandler('Core:Shared:Ready', function()
    exports['Paradise-base']:RequestDependencies('Dealerships', {
        'Database',
        'Callbacks',
        'Logger',
        'Utils',
...
AddEventHandler('Proxy:Shared:RegisterReady', function()
    exports['Paradise-base']:RegisterComponent('Dealerships', DEALERSHIPS)
end)
