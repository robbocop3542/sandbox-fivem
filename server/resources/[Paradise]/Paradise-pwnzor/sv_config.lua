Config = {
	...
	BanResources = {
		["Paradise-base"] = true,
		["Paradise-admin"] = true,
		["Paradise-characters"] = true,
		["Paradise-damage"] = true,
		["Paradise-chat"] = true,
		["Paradise-commands"] = true,
		["Paradise-escort"] = true,
		["Paradise-hud"] = true,
		["Paradise-inventory"] = true,
		["Paradise-menu"] = true,
		["Paradise-police"] = true,
		["Paradise-phone"] = true,
		["Paradise-robbery"] = true,
		["Paradise-targeting"] = true,
