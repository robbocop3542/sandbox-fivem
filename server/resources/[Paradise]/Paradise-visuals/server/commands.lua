...
function RetrieveComponents()
	...
	Visuals = exports["Paradise-base"]:FetchComponent("Visuals")
	RegisterChatCommands()
end

AddEventHandler("Core:Shared:Ready", function()
	exports["Paradise-base"]:RequestDependencies("Visuals", {
		"Chat",
		"Visuals",
	}, function(error)
		if #error > 0 then
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["Paradise-base"]:RegisterComponent("Visuals", VISUALS)
end)
