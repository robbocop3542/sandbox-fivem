...
function RetrieveComponents()
	...
	Scenes = exports["Paradise-base"]:FetchComponent("Scenes")
end

AddEventHandler("Core:Shared:Ready", function()
	exports["Paradise-base"]:RequestDependencies("Scenes", {
		"Fetch",
		"Utils",
		"Execute",
		"Chat",
		...
		if #error > 0 then
			exports["Paradise-base"]:FetchComponent("Logger"):Critical("Scenes", "Failed To Load All Dependencies")
			return
		end
		RetrieveComponents()
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["Paradise-base"]:RegisterComponent("Scenes", _SCENES)
end)
