COMPONENTS.Discord = {
	...
	RichPresence = function(self)
		...
		SetDiscordRichPresenceAsset("Paradiserp_large_icon")
		SetDiscordRichPresenceAssetText("Join Today: ParadiseRP.gg")
		--SetDiscordRichPresenceAssetSmall("info")
		SetDiscordRichPresenceAction(0, "Apply Now", "https://Paradiserp.gg")
		SetDiscordRichPresenceAction(1, "Join Our Discord", "https://discord.gg/Paradisegg")
