...
function RetrieveComponents()
	...
	Police = exports["Paradise-base"]:FetchComponent("Police")
...
AddEventHandler("Core:Shared:Ready", function()
	exports["Paradise-base"]:RequestDependencies("Properties", {
		"Callbacks",
		"Middleware",
		"Logger",
		"Fetch",
...
AddEventHandler("Proxy:Shared:RegisterReady", function()
	exports["Paradise-base"]:RegisterComponent("Properties", PROPERTIES)
end)
